...
public class TraceAnalysis {
    ...
    private Map<String, List<Patch>> modifiedMethodMap = new HashMap<>();
    private Map<String, List<Patch>> equalTraceMap = new HashMap<>();
    //private static String mapPath
    private static String resultFile = Constant.TRACE_RESULT_HOME + "TraceAnalysis.log";

    public TraceAnalysis(Project subject) {
    ...
    public void paritionEquivalence() {
        ...
        for (Patch patchFile : patchFiles) {
            ...
            if (equalTraceMap.containsKey(traceContent)) {
                ...
                List<Patch> tmpList = new LinkedList<>();
    ...
    public void analysisEqualClass() {
       ...
       FileIO.writeStringToLog(resultFile, "Total Patches Number: " + subject.getPatchList().size());
        ...
        for (List<Patch> patchFiles : equalTraceMap.values()) {
    ...
    public void getDifference() {
        ...
        log.info(subject.getPatchList().stream().map(Patch::getPatchName).collect(Collectors.joining("\t")));
