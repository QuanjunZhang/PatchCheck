 ...
 */
  public static double[] bracket(  UnivariateRealFunction function,  double initial,  double lowerBound,  double upperBound,  int maximumIterations) throws ConvergenceException, FunctionEvaluationException {
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils#double[]#bracket#?,UnivariateRealFunction,double,double,double,int START#0");
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","function: ",function);
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","initial: ",initial);
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","lowerBound: ",lowerBound);
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","upperBound: ",upperBound);
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","maximumIterations: ",maximumIterations);
    if (function == null) {
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","function: ",function);
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","initial: ",initial);
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","lowerBound: ",lowerBound);
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","upperBound: ",upperBound);
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","maximumIterations: ",maximumIterations);
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils#double[]#bracket#?,UnivariateRealFunction,double,double,double,int END#0");
      throw (RuntimeException)auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","MathRuntimeException.createIllegalArgumentException(\"function is null\"): ",MathRuntimeException.createIllegalArgumentException("function is null"));
    }
    if (maximumIterations <= 0) {
      ...
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","maximumIterations: ",maximumIterations);
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils#double[]#bracket#?,UnivariateRealFunction,double,double,double,int END#0");
      throw (RuntimeException)auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","MathRuntimeException.createIllegalArgumentException(\"bad value for maximum iterations number: {0}\",maximumIterations): ",MathRuntimeException.createIllegalArgumentException("bad value for maximum iterations number: {0}",maximumIterations));
    }
    if (initial < lowerBound || initial > upperBound || lowerBound >= upperBound) {
      ...
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","maximumIterations: ",maximumIterations);
      auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils#double[]#bracket#?,UnivariateRealFunction,double,double,double,int END#0");
      throw (RuntimeException)auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","MathRuntimeException.createIllegalArgumentException(\"invalid bracketing parameters:  lower bound={0},  initial={1}, upper bound={2}\",lowerBound,initial,upperBound): ",MathRuntimeException.createIllegalArgumentException("invalid bracketing parameters:  lower bound={0},  initial={1}, upper bound={2}",lowerBound,initial,upperBound));
    }
    double a=initial;
    double b=initial;
    double fa;
 ...
 while ((fa * fb > 0.0) && (numIterations < maximumIterations) && ((a > lowerBound) || (b < upperBound)));
    ...
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","maximumIterations: ",maximumIterations);
    auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","org.apache.commons.math.analysis.solvers.UnivariateRealSolverUtils#double[]#bracket#?,UnivariateRealFunction,double,double,double,int END#0");
    return (double[])auxiliary.Dumper.write("/home/xushicheng/eclipse-workspace/PatchCheck/tmp/Math/85//state/Nopol2017-Patch174_state","new double[]{a,b}: ",new double[]{a,b});
  }
  /** 
